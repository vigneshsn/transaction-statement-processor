...
import com.vigneshsn.statementprocessor.exceptions.ApplicationExceptionHandler;
...
public class TransactionStatementProcessControllerTest {
    ...
    public void should_process_transaction_file_and_return_duplicate_and_incorrect_transactions() throws Exception {
        ...
        Mockito.when(genericTransactionStatementProcessor.process(mockMultipartFile)).thenReturn(prepareTransactionList());
